 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),S=` ${s} `;class v{constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let r=0;r<t;r++){const t=this.strings[r],o=t.lastIndexOf("\x3c!--");n=(o>-1||n)&&-1===t.indexOf("--\x3e",o+1);const a=h.exec(t);e+=null===a?t+(n?S:i):t.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+s}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==y&&(e=y.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const z=(t,...e)=>new v(t,e,"html",$)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");const X={};class Y extends D{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(Array.isArray(t)){const e=(t,s)=>t.reduceRight(((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t)),s),s=e(t,new Set),i=[];s.forEach((t=>i.unshift(t))),this._styles=i}else this._styles=void 0===t?[]:[t];this._styles=this._styles.map((t=>{if(t instanceof CSSStyleSheet&&!J){const e=Array.prototype.slice.call(t.cssRules).reduce(((t,e)=>t+e.cssText),"");return new G(String(e),K)}return t}))}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?J?this.renderRoot.adoptedStyleSheets=t.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map((t=>t.cssText)),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==X&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach((t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)})))}render(){return X}}Y.finalized=!0,Y.render=(t,s,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const n=i.scopeName,r=R.has(s),o=q&&11===s.nodeType&&!!s.host,a=o&&!L.has(n),l=a?document.createDocumentFragment():s;if(((t,s,i)=>{let n=R.get(s);void 0===n&&(e(s,s.firstChild),R.set(s,n=new C(Object.assign({templateFactory:k},i))),n.appendInto(s)),n.setValue(t),n.commit()})(t,l,Object.assign({templateFactory:I(n)},i)),a){const t=R.get(l);R.delete(l);const i=t.value instanceof g?t.value.template:void 0;B(n,l,i),e(s,s.firstChild),s.appendChild(l),R.set(s,t)}!r&&o&&window.ShadyCSS.styleElement(s.host)},Y.shadowRootOptions={mode:"open"};const Z=t=>class extends t{get storageKey(){return this.docid?`${this.docid}:vellum-sheet-field-${tt(this.label)}`:`vellum-sheet-field-${tt(this.label)}`}get storedValue(){return localStorage[this.storageKey]||""}set storedValue(t){localStorage[this.storageKey]=t}connectedCallback(){super.connectedCallback(),this.editable&&this.store&&(this.value=this.storedValue)}performUpdate(){if(super.performUpdate(),this.editable&&this.store){this.storedValue=this.value;this.shadowRoot.querySelector("#input").value=this.value}}},tt=t=>t.toString().normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/\s+/g,"-").replace(/[^\w-]+/g,"").replace(/--+/g,"-");class et extends(Z(Y)){static get is(){return"vellum-sheet-field"}static get styles(){return Q`
    ...
    :host([class~="horizontal"]) h2 {
      ...
      font-size: 12px;
    }`}static get properties(){return{label:{type:String},lines:{type:Number},editable:{type:Boolean},store:{type:Boolean},sync:{type:Boolean},docid:{type:String},value:{type:String}}}constructor(){super(),this.lines=1}connectedCallback(){super.connectedCallback(),this.sync=!0===this.sync,this.editable=!0===this.editable}updateValue(t){this.editable&&(this.value=t.target.value)}render(){return z`
    <div class="content">
      ${this.editable||this.sync?this._renderInput():z`<p><slot></slot></p>`}
      ${this.lines>1?[...Array(this.lines-1)].map((t=>z`<p></p>`)):z``}
      <h2>${this.label}</h2>
    </div>`}_renderInput(){return z`<input id="input" type="text" ?disabled=${!this.editable} @input=${this.updateValue} value="${this.value||""}">`}}customElements.define(et.is,et);
