...
window.threeMeetConnections.localConnection = new RTCPeerConnection()
window.threeMeetConnections.channel = window.threeMeetConnections.localConnection.createDataChannel("char-sheet-updates")
...
if(code) {
  ...
  console.log(offer)
  window.threeMeetConnections.localConnection.setRemoteDescription(offer)
